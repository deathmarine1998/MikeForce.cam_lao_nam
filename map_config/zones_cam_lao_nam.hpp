...
zone_saigon[] = {
	...
	{"zone_tam_pep", "connector_saigon_tam_pep"}
};
...
zone_cu_chi[] = {
	...
	{"zone_hamburger_hill", "connector_cu_chi_hamburger_hill"}
};
...
zone_fsb_quan_loi[] = {
	...
	{"zone_hamburger_hill", "connector_quan_loi_hamburger_hill"}
};

zone_hamburger_hill[] = {
	{"zone_fsb_quan_loi", "connector_hamburger_hill_quan_loi"},
	{"zone_da_krong", "connector_hamburger_hill_da_krong"},
	{"zone_khe_gio_valley", "connector_hamburger_hill_khe_gio_valley"}
};

zone_khe_gio_valley[] = {
	{"zone_hue", "connector_khe_gio_valley_hue"},
	{"zone_da_krong", "connector_khe_gio_valley_da_krong"},
...
zone_hue[] = {
	...
	{"zone_na_lai", "connector_hue_na_lai"}
};

zone_da_krong[] = {
	{"zone_attapeu", "connector_da_krong_attapeu"},
	{"zone_bru_village", "connector_da_krong_bru_village"}
};

zone_attapeu[] = {
	{"zone_plain_of_jars", "connector_attapeu_plain_of_jars"},
	{"zone_mss_leghorn", "connector_attapeu_mss_leghorn"}
};
...
zone_va_cang[] = {
	...
	{"zone_bam_bon", "connector_va_cang_bam_bon"}
};
...
zone_da_nang[] = {
	{"zone_hue", "connector_da_nang_hue"}
};

zone_ling_ho[] = {
	{"zone_ca_loi", "connector_ling_ho_ca_loi"}
};

zone_mss_leghorn[] = {
	{"zone_mu_gia_pass", "connector_mss_leghorn_mu_gia_pass"}
};

zone_tam_pep[] = {
	{"zone_soc_trang", "connector_tam_pep_soc_trang"}
};

zone_bam_bon[] = {
	{"zone_plain_of_jars", "connector_plain_of_jars_bam_bon"}
};

zone_bru_village[] = {
	{"zone_rung_cung", "connector_bru_village_rung_cung"}
};
