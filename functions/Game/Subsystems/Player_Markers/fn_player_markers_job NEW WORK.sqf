...

{
	...
	switch(_unitGroup) do {
		case "ACAV": {_unitGroupColor = "ColorOrange"; };
		case "DacCong": {_unitGroupColor = "ColorEAST"; vn_mf_player_markers_daccong pushBack _unitMarker; };
		...
		default {_unitGroupColor = "ColorBLUFOR"; };
	}
