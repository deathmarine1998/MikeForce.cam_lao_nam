...
private _debug = getNumber(missionConfigFile >> "gamemode" >> "debug" >> "zones");
private _markerAlpha = getNumber(missionConfigFile >> "gamemode" >> "settings" >> "aimarkers" >> "zone");
///////////////////
// Config Values //
///////////////////
...
// All zone names
mf_s_zone_markers = [];
// All zone's opened during uptime
mf_s_opened_zones = [];
...
vn_mf_completedZones = ["GET", "completed_zones", []] call para_s_fnc_profile_db select 1;
publicVariable "vn_mf_completedZones";
