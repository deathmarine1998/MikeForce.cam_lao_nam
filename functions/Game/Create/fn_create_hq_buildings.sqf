...
if(toLower(worldName) in ["cam_lao_nam", "vn_khe_sanh"])then {
	vn_mf_hq_composition = [
		...
		["Land_Map_unfolded_F",[0.21,-6.40684,0.85],200,1,0,[0,0],"","",false,false],   
		["vn_o_prop_t102e_01",[0.24707,-7.00684,0.85],222.587,1,0,[0,0],"","",false,false], 
...
if(toLower(worldName) in ["altis", "tanoa"])then {
	vn_mf_hq_composition = [
		["Land_vn_pavn_weapons_stack3",[0.99707,2.85059,0],65.7312,1,0,[0,0],"","",true,false], 
		["Land_vn_pavn_weapons_stack1",[-1.94336,2.70313,0.00320292],125.043,1,0,[0,-0],"","",true,false], 
		["CamoNet_OPFOR_F",[3.8125,2.74316,0],0,1,0,[0,0],"","",true,false], 
		["Land_vn_pavn_weapons_stack2",[4.29102,2.57031,0.00285816],32.5782,1,0,[0,0],"","",true,false], 
		["Land_BagBunker_Small_F",[1.21582,-6.43945,0],193.762,1,0,[0,0],"","",true,false], 
		["rhs_KORD_high_MSV",[-6.22266,-2.72168,-0.0749993],255.893,1,0,[0,0],"","",true,false], 
		["Land_vn_woodentable_small_f",[0.217773,-7.01855,0],324.084,1,0,[0,0],"","",false,false],
		["Land_Map_unfolded_F",[0.21,-6.40684,0.85],200,1,0,[0,0],"","",false,false],   
		["vn_o_prop_t102e_01",[0.24707,-7.00684,0.85],222.587,1,0,[0,0],"","",false,false], 
		["rhs_KORD_high_MSV",[3.37109,6.85156,-0.0749993],15.0513,1,0,[0,0],"","",true,false], 
		["rhs_KORD_high_MSV",[5.81836,-5.98047,-0.0749993],130.326,1,0,[0,-0],"","",true,false], 
		["GRAD_envelope_giant",[-7.31543,-3.46191,0],249.218,1,0,[0,0],"","",false,false], 
		["GRAD_envelope_giant",[3.63379,7.58398,0],15.3497,1,0,[0,0],"","",false,false], 
		["GRAD_envelope_giant",[6.83301,-6.43848,0],131.823,1,0,[0,-0],"","",false,false], 
		["Land_Cargo_Patrol_V3_F",[-14.6172,15.9551,0],41.257,1,0,[0,0],"","",false,false], 
		["Land_Cargo_Patrol_V3_F",[23.667,5.99023,0],165.404,1,0,[0,-0],"","",false,false], 
		["Land_Cargo_Patrol_V3_F",[-2.19238,-25.3643,0],267.329,1,0,[0,0],"","",false,false]
	];
};
...
private _hqObjects = [_position, 0, vn_mf_hq_composition] call BIS_fnc_objectsMapper;
{
	...
	if (typeOf _x == "Land_vn_pavn_weapons_stack1") then { 
		vn_mf_hq_locations = [_x, _position];
	};
