...
_dataStore setVariable ["INIT", {
	...
	private _defenseScaling = _taskDataStore getVariable ["defenseScaling", [1, 1]];
	_taskDataStore setVariable ["defenseScaling", _defenseScaling];

	private _tunnelWS = ["Land_vn_o_trapdoor_02", _spawnPos] call para_g_fnc_create_vehicle;
	private _buildings = [_tunnelWS];
