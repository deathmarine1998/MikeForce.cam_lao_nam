...
_taskDataStore setVariable ["INIT", {
	...
	private _unitCfg = (missionConfigFile >> "gamemode" >> "modded_ops");
	private _unitMod = getText(_unitCfg >> "units_bronation");
	private _unitOfficer = getText(missionConfigFile >> "gamemode" >> _unitMod >> "units_officer_name");
	
	private _taxCollector = [
		_result # 1, 
		selectRandom getArray (_unitCfg >> _unitMod >> "east" >> _unitOfficer),
		_spawnPos,
		[],
		5,
		"NONE"
