...
PrisonerOfWar = true;
private _cells = format["dcprisoncells_%1",toLower(worldName)];
private _prisonLocs = getArray(missionConfigFile >> "gamemode" >> "settings" >> "powcages" >> _cells);
private _prisonClothes = getArray(missionConfigFile >> "gamemode" >> "settings" >> "powcages" >> "dcprisonclothes");
...
_abductee addItem "FirstAidKit";
_abductee setDir 90;
["GICaptured"] call para_c_fnc_show_notification;