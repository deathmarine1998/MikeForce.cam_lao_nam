...
0 fadeMusic 0;
playMusic selectRandom ["vn_blues_for_suzy", "vn_kitty_bar_blues", "vn_drafted", "vn_another_life", "vn_behind_enemy_lines", "vn_calm_before_the_storm", "vn_contact", "vn_deadly_jungle", "vn_dont_cry_baby", "vn_fire_in_the_sky", "vn_freedom_bird", "vn_hell_on_earth", "vn_route9", "vn_tequila_highway"];
4 fadeMusic 1;