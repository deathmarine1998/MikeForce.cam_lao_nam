...
class vn_tr_selectTeam_base : vn_mf_RscControlsGroupNoScrollbarHV
{
	...
	class controls
	{
		...
		class logoEC: vn_mf_RscButton_ImgSwitch
		{
			...
			text = "custom\taskroster\easycompany_gray.paa";
			textUp = "custom\taskroster\easycompany_HL.paa";
			
			onButtonClick = "['EasyCompany'] call vn_mf_fnc_tr_selectTeam;";
		};
		// middle center left
		...
		// bottom left
		class logoCDT: vn_mf_RscButton_ImgSwitch
		{
			idc = VN_TR_SELECTTEAM_TEAM_LOGO_CDT_IDC;
			x = UIW(2); //(9.75);
			y = UIH(15.75); //(12);
			w = UIW(3);
			h = UIH(3);
			...
			text = "custom\taskroster\bncadet_gray.paa";
			textUp = "custom\taskroster\bncadet_HL.paa";
			
			onButtonClick = "['BNCadet'] call vn_mf_fnc_tr_selectTeam;";
		};
		// bottom center left
...
class vn_tr_MainInfo_base : vn_mf_RscControlsGroupNoScrollbarHV
{
	...
	class controls
	{
		...
		class ccmf_btn: vn_mf_RscButton_ImgSwitch
		{
			...
			tooltip = "";
			text = "\vn\ui_f_vietnam\ui\taskroster\img\logos\Logo_MikeForce_HL.paa";
			onButtonClick = "1 radioChannelAdd [player];6 enableChannel [true, true];";
		};
		class ccmfoff_btn: vn_mf_RscButton_ImgSwitch
		{
			...
			tooltip = "";
			text = "\vn\ui_f_vietnam\ui\taskroster\img\logos\Logo_MikeForce.paa";
			onButtonClick = "1 radioChannelRemove [player];";
		};
		...
		class ccac_btn: vn_mf_RscButton_ImgSwitch
		{
			...
			onButtonClick = "3 radioChannelAdd [player];8 enableChannel [true, true];";
		};
		class ccacoff_btn: vn_mf_RscButton_ImgSwitch
		{
			...
			tooltip = "";
			text = "\vn\ui_f_vietnam\ui\taskroster\img\logos\Logo_ACAV.paa";
			onButtonClick = "3 radioChannelRemove [player];";
		};
		...
		class ccgh_btn: vn_mf_RscButton_ImgSwitch
		{
			...
			onButtonClick = "2 radioChannelAdd [player];7 enableChannel [true, true];";
		};
		class ccghoff_btn: vn_mf_RscButton_ImgSwitch
		{
			...
			tooltip = "";
			text = "\vn\ui_f_vietnam\ui\taskroster\img\logos\Logo_Hornets.paa";
			onButtonClick = "2 radioChannelRemove [player];";
		};

		class ccst_btn: vn_mf_RscButton_ImgSwitch
		{
			idc = VN_TR_CCST_BTN_IDC;
			x = UIW(16.5);
			y = UIH(6.5);
			w = UIW(1);
			h = UIH(1);
			tooltip = "";
			text = "\vn\ui_f_vietnam\ui\taskroster\img\logos\Logo_SpikeTeam_HL.paa";
			onButtonClick = "4 radioChannelAdd [player];9 enableChannel [true, true];";
		};
		class ccstoff_btn: vn_mf_RscButton_ImgSwitch
		{
			idc = VN_TR_CCSTOFF_BTN_IDC;
			x = UIW(17.75);
			y = UIH(6.5);
			w = UIW(1);
			h = UIH(1);
			tooltip = "";
			text = "\vn\ui_f_vietnam\ui\taskroster\img\logos\Logo_SpikeTeam.paa";
			onButtonClick = "4 radioChannelRemove [player];";
		};
		
		class ccmp_btn: vn_mf_RscButton_ImgSwitch
		{
			idc = VN_TR_CCMP_BTN_IDC;
			x = UIW(16.5);
			y = UIH(8);
			w = UIW(1);
			h = UIH(1);
...
class vn_tr_ciaPanel_base : vn_mf_RscControlsGroupNoScrollbarHV
{
	idc = -1;
	//onLoad = "(_this#0) ctrlenable false;";
	onLoad = "";
	...
	class controls
	{
		...
		class playerListBox: vn_mf_RscListNBox
		{
		...
		class zoneListBox: vn_mf_RscListNBox
		{
			idc = VN_TR_CIAPANEL_ZONE_LISTBOX_IDC;
			x = UIW(12);
			y = UIH(4.75);
			w = UIW(5);
			h = UIH(5);
		...
		class teleport2Player: vn_mf_RscButton
		{
			...
			onButtonClick = "player setPOS (getPOS VN_MF_PHOENIX_PLAYER_LIST_BOX_SELECTION);";
		};
		class Button2: vn_mf_RscButton
		{
			idc = VN_TR_CIAPANEL_Button2_IDC;
			x = 34 * GUI_GRID_W + GUI_GRID_X;
			y = 5 * GUI_GRID_H + GUI_GRID_Y;
			w = 5 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		};
		class Button3: vn_mf_RscButton
		{
			idc = VN_TR_CIAPANEL_Button3_IDC;
			x = 34 * GUI_GRID_W + GUI_GRID_X;
			y = 7 * GUI_GRID_H + GUI_GRID_Y;
			w = 5 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		};
		class Button4: vn_mf_RscButton
		{
			idc = VN_TR_CIAPANEL_Button4_IDC;
			x = 34 * GUI_GRID_W + GUI_GRID_X;
			y = 9 * GUI_GRID_H + GUI_GRID_Y;
			w = 5 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		};
		class Button5: vn_mf_RscButton
		{
			idc = VN_TR_CIAPANEL_Button5_IDC;
			x = 34 * GUI_GRID_W + GUI_GRID_X;
			y = 13 * GUI_GRID_H + GUI_GRID_Y;
			w = 5 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		};
		class Button6: vn_mf_RscButton
		{
			idc = VN_TR_CIAPANEL_Button6_IDC;
			x = 34 * GUI_GRID_W + GUI_GRID_X;
			y = 15 * GUI_GRID_H + GUI_GRID_Y;
			w = 5 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		};
		class Button7: vn_mf_RscButton
		{
			idc = VN_TR_CIAPANEL_Button7_IDC;
			x = 34 * GUI_GRID_W + GUI_GRID_X;
			y = 17 * GUI_GRID_H + GUI_GRID_Y;
			w = 5 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		};
		class Button8: vn_mf_RscButton
		{
			idc = VN_TR_CIAPANEL_Button8_IDC;
			x = 34 * GUI_GRID_W + GUI_GRID_X;
