...
#define VN_TR_CIALOGO_IDC					412008
#define VN_TR_CIALOGO_CTRL					(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CIALOGO_IDC)
#define VN_TR_CIA_BTN_IDC					412009
#define VN_TR_CIA_BTN_CTRL					(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CIA_BTN_IDC)

//Custom Comms
#define VN_TR_CCMF_BTN_IDC					415002
#define VN_TR_CCMF_BTN_CTRL					(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCMF_BTN_IDC)
#define VN_TR_CCMFOFF_BTN_IDC				415003
#define VN_TR_CCMFOFF_BTN_CTRL				(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCMFOFF_BTN_IDC)
#define VN_TR_CCAC_BTN_IDC					415004
#define VN_TR_CCAC_BTN_CTRL					(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCAC_BTN_IDC)
#define VN_TR_CCACOFF_BTN_IDC				415005
#define VN_TR_CCACOFF_BTN_CTRL				(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCACOFF_BTN_IDC)
#define VN_TR_CCGH_BTN_IDC					415006
#define VN_TR_CCGH_BTN_CTRL					(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCGH_BTN_IDC)
#define VN_TR_CCGHOFF_BTN_IDC				415007
#define VN_TR_CCGHOFF_BTN_CTRL				(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCGHOFF_BTN_IDC)
#define VN_TR_CCST_BTN_IDC					415008
#define VN_TR_CCST_BTN_CTRL					(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCST_BTN_IDC)
#define VN_TR_CCSTOFF_BTN_IDC				415009
#define VN_TR_CCSTOFF_BTN_CTRL				(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCSTOFF_BTN_IDC)
#define VN_TR_CCMP_BTN_IDC					415010
#define VN_TR_CCMP_BTN_CTRL					(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCMP_BTN_IDC)
#define VN_TR_CCMPOFF_BTN_IDC				415011
#define VN_TR_CCMPOFF_BTN_CTRL				(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCMPOFF_BTN_IDC)
#define VN_TR_CCMACV_BTN_IDC				415012
#define VN_TR_CCMACV_BTN_CTRL				(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCMACV_BTN_IDC)
#define VN_TR_CCMACVOFF_BTN_IDC				415013
#define VN_TR_CCMACVOFF_BTN_CTRL			(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCMACVOFF_BTN_IDC)

#define VN_TR_CCDC_BTN_IDC					415020
#define VN_TR_CCDC_BTN_CTRL					(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCDC_BTN_IDC)
#define VN_TR_CCDCOFF_BTN_IDC				415021
#define VN_TR_CCDCOFF_BTN_CTRL				(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_CCDCOFF_BTN_IDC)


#define VN_TR_ZONE_A_IDC					412010
#define VN_TR_ZONE_A_CTRL					(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_ZONE_A_IDC)
#define VN_TR_ZONE_A_FLAG_IDC				412012
#define VN_TR_ZONE_A_FLAG_CTRL				(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_ZONE_A_FLAG_IDC)

#define VN_TR_ZONE_B_IDC					412011
#define VN_TR_ZONE_B_CTRL					(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_ZONE_B_IDC)
#define VN_TR_ZONE_B_FLAG_IDC				412013
#define VN_TR_ZONE_B_FLAG_CTRL				(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_ZONE_B_FLAG_IDC)
...
//Accept Buttons
#define VN_TR_SELECTTEAM_ACCEPT_IDC					45013
#define VN_TR_SELECTTEAM_ACCEPT_CTRL				(VN_DISP_TR_SELECTTEAM displayCtrl VN_TR_SELECTTEAM_ACCEPT_IDC)
#define VN_TR_SELECTTEAM_CANCEL_IDC					45014
#define VN_TR_SELECTTEAM_CANCEL_CTRL				(VN_DISP_TR_SELECTTEAM displayCtrl VN_TR_SELECTTEAM_CANCEL_IDC)
...
// New Teams
#define VN_TR_SELECTTEAM_TEAM_LOGO_SA_IDC			45051
#define VN_TR_SELECTTEAM_TEAM_LOGO_SA_CTRL			(VN_TR_SELECTTEAM_TEAM_SELECTION_CTRL controlsGroupCtrl VN_TR_SELECTTEAM_TEAM_LOGO_SA_IDC)
#define VN_TR_SELECTTEAM_TEAM_LOGO_BH_IDC			45052
#define VN_TR_SELECTTEAM_TEAM_LOGO_BH_CTRL			(VN_TR_SELECTTEAM_TEAM_SELECTION_CTRL controlsGroupCtrl VN_TR_SELECTTEAM_TEAM_LOGO_BH_IDC)
#define VN_TR_SELECTTEAM_TEAM_LOGO_MACV_IDC			45053
#define VN_TR_SELECTTEAM_TEAM_LOGO_MACV_CTRL		(VN_TR_SELECTTEAM_TEAM_SELECTION_CTRL controlsGroupCtrl VN_TR_SELECTTEAM_TEAM_LOGO_MACV_IDC)
#define VN_TR_SELECTTEAM_TEAM_LOGO_TF_IDC			45054
#define VN_TR_SELECTTEAM_TEAM_LOGO_TF_CTRL			(VN_TR_SELECTTEAM_TEAM_SELECTION_CTRL controlsGroupCtrl VN_TR_SELECTTEAM_TEAM_LOGO_TF_IDC)
#define VN_TR_SELECTTEAM_TEAM_LOGO_EC_IDC			45055
#define VN_TR_SELECTTEAM_TEAM_LOGO_EC_CTRL			(VN_TR_SELECTTEAM_TEAM_SELECTION_CTRL controlsGroupCtrl VN_TR_SELECTTEAM_TEAM_LOGO_EC_IDC)
#define VN_TR_SELECTTEAM_TEAM_LOGO_MP_IDC			45056
#define VN_TR_SELECTTEAM_TEAM_LOGO_MP_CTRL			(VN_TR_SELECTTEAM_TEAM_SELECTION_CTRL controlsGroupCtrl VN_TR_SELECTTEAM_TEAM_LOGO_MP_IDC)
#define VN_TR_SELECTTEAM_TEAM_LOGO_MK_IDC			45057
#define VN_TR_SELECTTEAM_TEAM_LOGO_MK_CTRL			(VN_TR_SELECTTEAM_TEAM_SELECTION_CTRL controlsGroupCtrl VN_TR_SELECTTEAM_TEAM_LOGO_MK_IDC)
#define VN_TR_SELECTTEAM_TEAM_LOGO_FM_IDC			45058
#define VN_TR_SELECTTEAM_TEAM_LOGO_FM_CTRL			(VN_TR_SELECTTEAM_TEAM_SELECTION_CTRL controlsGroupCtrl VN_TR_SELECTTEAM_TEAM_LOGO_FM_IDC)
#define VN_TR_SELECTTEAM_TEAM_LOGO_MO_IDC			45059
#define VN_TR_SELECTTEAM_TEAM_LOGO_MO_CTRL			(VN_TR_SELECTTEAM_TEAM_SELECTION_CTRL controlsGroupCtrl VN_TR_SELECTTEAM_TEAM_LOGO_MO_IDC)
#define VN_TR_SELECTTEAM_TEAM_LOGO_PC_IDC			45060
#define VN_TR_SELECTTEAM_TEAM_LOGO_PC_CTRL			(VN_TR_SELECTTEAM_TEAM_SELECTION_CTRL controlsGroupCtrl VN_TR_SELECTTEAM_TEAM_LOGO_PC_IDC)

#define VN_TR_SELECTTEAM_TEAM_LOGO_GS_IDC			45061
#define VN_TR_SELECTTEAM_TEAM_LOGO_GS_CTRL			(VN_TR_SELECTTEAM_TEAM_SELECTION_CTRL controlsGroupCtrl VN_TR_SELECTTEAM_TEAM_LOGO_GS_IDC)

#define VN_TR_SELECTTEAM_TEAM_LOGO_SASR_IDC			45062
#define VN_TR_SELECTTEAM_TEAM_LOGO_SASR_CTRL		(VN_TR_SELECTTEAM_TEAM_SELECTION_CTRL controlsGroupCtrl VN_TR_SELECTTEAM_TEAM_LOGO_SASR_IDC)


// CIA Panel
#define VN_IDD_TR_CIAPANEL							46001
#define VN_DISP_TR_CIAPANEL							(uinamespace getvariable ["vn_tr_disp_ciaPanel", DisplayNull])

#define VN_TR_CIAPANEL_PHOENIX_PROGRAM_IDC			46070
#define VN_TR_CIAPANEL_PHOENIX_PROGRAM_CTRL			(VN_DISP_TR_CIAPANEL displayCtrl VN_TR_CIAPANEL_PHOENIX_PROGRAM_IDC)

#define VN_TR_CIAPANEL_PLAYER_LISTBOX_IDC			46010
#define VN_TR_CIAPANEL_PLAYER_LISTBOX_CTRL			(VN_TR_CIAPANEL_PHOENIX_PROGRAM_CTRL controlsGroupCtrl VN_TR_CIAPANEL_PLAYER_LISTBOX_IDC)
#define VN_TR_CIAPANEL_ZONE_LISTBOX_IDC				46011
#define VN_TR_CIAPANEL_ZONE_LISTBOX_CTRL			(VN_TR_CIAPANEL_PHOENIX_PROGRAM_CTRL controlsGroupCtrl VN_TR_CIAPANEL_ZONE_LISTBOX_IDC)

#define VN_TR_CIAPANEL_TP2_PLAYER_IDC				46030
#define VN_TR_CIAPANEL_TP2_PLAYER_CTRL				(VN_TR_CIAPANEL_PHOENIX_PROGRAM_CTRL controlsGroupCtrl VN_TR_CIAPANEL_TP2_PLAYER_IDC)
#define VN_TR_CIAPANEL_Button2_IDC					46031
#define VN_TR_CIAPANEL_Button2_CTRL					(VN_TR_CIAPANEL_PHOENIX_PROGRAM_CTRL controlsGroupCtrl VN_TR_CIAPANEL_Button2_IDC)
#define VN_TR_CIAPANEL_Button3_IDC					46032
#define VN_TR_CIAPANEL_Button3_CTRL					(VN_TR_CIAPANEL_PHOENIX_PROGRAM_CTRL controlsGroupCtrl VN_TR_CIAPANEL_Button3_IDC)
#define VN_TR_CIAPANEL_Button4_IDC					46033
#define VN_TR_CIAPANEL_Button4_CTRL					(VN_TR_CIAPANEL_PHOENIX_PROGRAM_CTRL controlsGroupCtrl VN_TR_CIAPANEL_Button4_IDC)
#define VN_TR_CIAPANEL_Button5_IDC					46034
#define VN_TR_CIAPANEL_Button5_CTRL					(VN_TR_CIAPANEL_PHOENIX_PROGRAM_CTRL controlsGroupCtrl VN_TR_CIAPANEL_Button5_IDC)
#define VN_TR_CIAPANEL_Button6_IDC					46035
#define VN_TR_CIAPANEL_Button6_CTRL					(VN_TR_CIAPANEL_PHOENIX_PROGRAM_CTRL controlsGroupCtrl VN_TR_CIAPANEL_Button6_IDC)
#define VN_TR_CIAPANEL_Button7_IDC					46036
#define VN_TR_CIAPANEL_Button7_CTRL					(VN_TR_CIAPANEL_PHOENIX_PROGRAM_CTRL controlsGroupCtrl VN_TR_CIAPANEL_Button7_IDC)
#define VN_TR_CIAPANEL_Button8_IDC					46037
#define VN_TR_CIAPANEL_Button8_CTRL					(VN_TR_CIAPANEL_PHOENIX_PROGRAM_CTRL controlsGroupCtrl VN_TR_CIAPANEL_Button8_IDC)
