...
zone_cu_chi[] = {
	...
	{"zone_hamburger_hill", "connector_cu_chi_a_shau_valley"}
};
...
zone_fsb_quan_loi[] = {
	...
	{"zone_hamburger_hill", "connector_quan_loi_a_shau_valley"}
};

zone_hamburger_hill[] = {
	{"zone_fsb_quan_loi", "connector_hamburger_hill_quan_loi"},
	{"zone_khe_sanh", "connector_hamburger_hill_khe_sanh"},
	{"zone_khe_gio_valley", "connector_hamburger_hill_khe_gio_valley"}
};

zone_khe_gio_valley[] = {
	{"zone_hue", "connector_khe_gio_valley_hue"},
	{"zone_khe_sanh", "connector_khe_gio_valley_khe_sanh"},
	{"zone_hanoi_docks", "connector_khe_gio_valley_hanoi_docks"}
};
