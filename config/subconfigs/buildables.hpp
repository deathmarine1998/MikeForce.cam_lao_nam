...
class Land_vn_i_shed_ind_old_f
{
	...
	rank = 0;
	SUPPLY_CAPACITY(5000, DAYS_TO_SECONDS(1));
	resupply = "BuildingSupplies";
	conditions[] = {
		CONDITION_HAS_RANK,
		CONDITION_IS_ENGINEER,
	...
	class features
	{
		class vehicle_spawning
		{
			...
			spawnPositionModelSpace[] = {6.00293,3.26758,0.1};
...
class Land_vn_bagfence_corner_green_f
{
	name = "";
	type = "walls";
	categories[] = {"walls", "fortifications", "us", "nonAcav"};
	...
	class build_states
	{
		class initial_state
		{
			object_class = "Land_vn_bagfence_corner_green_f";
		};
		class middle_state
		{
			object_class = "Land_vn_bagfence_corner_green_f";
...
class Land_vn_bagfence_end_green_f
{
	name = "";
	type = "walls";
	categories[] = {"walls", "fortifications", "us", "nonAcav"};
	...
	class build_states
	{
		class initial_state
		{
			object_class = "Land_vn_bagfence_end_green_f";
		};
		class middle_state
		{
			object_class = "Land_vn_bagfence_end_green_f";
...
class Land_vn_bagfence_round_green_f
{
	name = "";
	type = "walls";
	categories[] = {"walls", "fortifications", "us", "nonAcav"};
	...
	class build_states
	{
		class initial_state
		{
			object_class = "Land_vn_bagfence_round_green_f";
		};
		class middle_state
		{
			object_class = "Land_vn_bagfence_round_green_f";
...
class Land_vn_bagfence_short_green_f
{
	name = "";
	type = "walls";
	categories[] = {"walls", "fortifications", "us", "nonAcav"};
	...
	class build_states
	{
		class initial_state
		{
			object_class = "vn_bagfence_short_green_f_part0";
		};
		class middle_state
		{
			object_class = "vn_bagfence_short_green_f_part1";
		};
		class final_state
		{
			object_class = "Land_vn_bagfence_short_green_f";
		};
	};
};
class vn_flag_usa
...
class vn_flagpole_f
{
	name = "";
	type = "fortifications";
	categories[] = {"fortifications", "nonAcav"};
	rank = 0;
	SUPPLY_CAPACITY(100, DAYS_TO_SECONDS(1));
	resupply = "BuildingSupplies";
	conditions[] = {
...
class Land_vn_landmark_f
{
	name = "";
	type = "BNOCustom";
	categories[] = {"BNOCustom", "nonAcav"};
	rank = 0;
	SUPPLY_CAPACITY(200, DAYS_TO_SECONDS(1));
	resupply = "BuildingSupplies";
	conditions[] = {
	...
	class build_states
	{
		class initial_state
		{
			object_class = "Land_vn_landmark_f";
		};
		class middle_state
		{
			object_class = "Land_vn_landmark_f";
...
class Land_vn_humanskull_f
{
	name = "";
	type = "BNOCustom";
	categories[] = {"BNOCustom", "medical", "nonAcav"};
	rank = 0;
	SUPPLY_CAPACITY(200, DAYS_TO_SECONDS(1));
	resupply = "BuildingSupplies";
	conditions[] = {
	...
	class build_states
	{
		class initial_state
		{
			object_class = "Land_vn_humanskull_f";
		};
		class middle_state
		{
			object_class = "Land_vn_humanskull_f";
