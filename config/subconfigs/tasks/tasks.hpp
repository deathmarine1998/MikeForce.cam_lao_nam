class task
{
	...
	taskgroups[] = {"MACVSOG","MikeForce","ACAV","GreenHornets","SpikeTeam","EasyCompany","SaigonWarriors","BlackHawk","Frogmen","Muskets","SatansAngels","TigerForce","Gunslingers","SASR","Montagnard","PressCorp","BNCadet","BNGunClub"}; // all
	requestgroups[] = {};
	tasktype = "walk";
	rankpoints = 0;
	taskprogress = 0;
