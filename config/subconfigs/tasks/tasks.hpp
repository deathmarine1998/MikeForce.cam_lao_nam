class task
{
	...
	taskgroups[] = {"MACV","MikeForce","ACAV","GreenHornets","SpikeTeam","EasyCompany","SaigonWarriors","BlackHawk","Frogmen","Muskets","SatansAngels","TigerForce","633rdCSG","SASR","Montagnard","PressCorp","BNCadet","BNGunClub"}; // all
	requestgroups[] = {};
	tasktype = "walk";
	rankpoints = 0;
	taskprogress = 0;
