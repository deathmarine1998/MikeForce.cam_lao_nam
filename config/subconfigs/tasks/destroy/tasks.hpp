class destroy_aa_site : task
{
	...
	taskgroups[] = {"MikeForce","SpikeTeam","ACAV","GreenHornets","EasyCompany","SaigonWarriors","BlackHawk","Frogmen","Muskets","SatansAngels","TigerForce","Montagnard","PressCorp"}; // all
	tasktype = "attack";
...
class destroy_camp : task
{
	...
	class find_and_destroy 
	{
		taskname = "Find the Camp";
		taskdesc = "Search and destroy the camp that's somewhere near this point.";
	};
};
...
class destroy_vehicle_depot : task
{
	...
	class find_and_destroy 
	{
		taskname = "S&D Vehicle Depot";
		taskdesc = "Search and destroy the vehicle supply point near these coordinates.";
	};
};