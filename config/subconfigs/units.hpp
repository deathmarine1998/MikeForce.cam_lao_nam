class units
{
	...
	units_vc_patrol[] = {"vc_regional_sentry","vc_main_sentry","vc_local_sentry","vc_local_patrol"}; 
	units_daccong_patrol[] = {"nva_dac_cong_sentry"};
	units_default_patrol[] = {"nva_main_sentry", "nva_main_patrol"};

	units_vc_standard[] = {"vc_regional_standard", "vc_main_standard", "vc_local_standard", "vc_regional_cover_element", "vc_local_cover_element", "vc_main_cover_element", "vc_regional_at", "vc_main_at", "vc_local_at"};
	units_daccong_standard[] = {"nva_dac_cong_standard", "nva_dac_cong_standard", "nva_dac_cong_at", "nva_dac_cong_cover_element"};
	units_default_standard[] = {"nva_main_standard", "nva_main_standard", "nva_main_cover_element", "nva_main_at"};
