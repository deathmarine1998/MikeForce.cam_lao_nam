...
class Land_vn_plot_green_branka
{
	name = "Your exit back to the war soldier! Great job!";
	icon = "";
	description = "Health: <t color='#FF0000'>%2%1</t><br/>Distance: %3m";
	variables[] = { "'%'", "round (100 - (damage _object) * 100)", "round (_object distance player)" };
};
...
class Bartender
{
	name = $STR_vn_mf_overlay_bar_tender_name;
	icon = "";
	description = $STR_vn_mf_overlay_bar_tender_description;
	variables[] = {};
};