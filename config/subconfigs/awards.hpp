class deaths
{
	class purple_heart
	{
		// "MikeForce","EasyCompany","MilitaryPolice","ACAV","BlackHawk","Frogmen","GreenHornets","Muskets","SatansAngels","SpikeTeam","TigerForce","Montagnard","MACV","PressCorp","DacCong"
	...
	class rvn_wound_medal
	{
		...
		required_teams[] = {"MikeForce","EasyCompany","MilitaryPolice","Frogmen","SpikeTeam","TigerForce","Montagnard","MACV","PressCorp","DacCong"};
		levels[] =
		{
			{1}
		};
...
class kills
{
	...
	{
		// 1 kill
		required_teams[] = {"MikeForce","EasyCompany","MilitaryPolice","ACAV","BlackHawk","Frogmen","GreenHornets","Muskets","SatansAngels","SpikeTeam","TigerForce","Montagnard","MACV","PressCorp","DacCong"};
	...
	class air_medal
	{
		...
		required_teams[] = {"EasyCompany","MilitaryPolice","BlackHawk","Frogmen","GreenHornets","Muskets","SatansAngels","TigerForce","Montagnard","MACV","PressCorp","DacCong"};
...
class teamtaskscomplete
{
	...
	{
		// Completion of 20 (secondary) Team tasks
		required_teams[] = {"EasyCompany","MilitaryPolice","BlackHawk","Frogmen","GreenHornets","Muskets","SatansAngels","SpikeTeam","TigerForce","Montagnard","MACV","PressCorp","DacCong"};
...
class supplytaskscomplete
{
	...
	{
		// 10 air to air kills
		required_teams[] = {"EasyCompany","MilitaryPolice","ACAV","BlackHawk","Frogmen","GreenHornets","Muskets","SatansAngels","SpikeTeam","TigerForce","Montagnard","MACV","PressCorp","DacCong"};
...
class rank
{
	class rvn_training_service_medal
	{
		...
		required_teams[] = {"MikeForce","EasyCompany","MilitaryPolice","BlackHawk","Frogmen","SpikeTeam","TigerForce","Montagnard","MACV","PressCorp","DacCong"};
