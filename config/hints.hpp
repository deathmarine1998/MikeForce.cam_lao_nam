class CfgHints
{
	class Overview {
		...
		class Fast_Travel {
			...
			description = "Fast travel is a quick way to travel around the main US bases for each team: Mike force, Spike team, Green Hornets, and to ACAV. You can fast travel by standing next to the map display in game and pressing the 6 key (default). Travelling in this way is free and instant!";
	...
	class Team {
		...
		class Satans_Angels {
			displayName = "Satans Angels";
			displayNameShort = "Satans Angels!";
			description = "Satans Angels are the chosen ones! They carry the biggest burden trying not to kill friendly soldiers out there in the jungle.";
			//image = "\vn\ui_f_vietnam\ui\mikeforce\survivalcards\<cardname>.paa";
			//Note: No image.
		};
		
		class Dac_Cong {
			displayName = "Dac Cong Commandos";
			displayNameShort = "Dac Cong Commandos!";
			description = "Dac Cong Commandos. These guys will ruin your day, dont mess with the Gook Squad!";
			//image = "\vn\ui_f_vietnam\ui\mikeforce\survivalcards\<cardname>.paa";
			//Note: No image.
		};
