class gamemode
{
	...
	class debug
	{
		#include "subconfigs\debug.hpp"
	};
	class kittybardrops
	{
		#include "subconfigs\kittybardrops.hpp"
	};
	class whitelisting
	{
		#include "subconfigs\whitelisting.hpp"
	};
	class customchat
	{
		#include "subconfigs\customchat.hpp"
	};
	class sites
	{
	...
	class safezones
	{
		#include "subconfigs\safezones.hpp"
	};
	class modded_ops
	{
		#include "subconfigs\modded_ops.hpp"
	};
	...
	#include "subconfigs\units_cup.hpp"
	#include "subconfigs\units_Pla.hpp"
};
