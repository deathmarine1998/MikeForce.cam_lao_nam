class CfgItemInteractions
{
	class AllAmmoSettings // this is a fake class that holds the settings for the ammo repack feature.
	{
		interactActions[] =
		{
			{"STR_vn_mf_remove", "call vn_mf_fnc_ammo_remove;" },
	...
	class dirty_water
	{
		attributes[] =
		{
			{"diarrhea", 0.25} // diuretic, diarrhea
		};
	};
	...
	class vn_prop_food_meal_01  //  (Ration 0.75Kg) Etc
	{
		...
		attributes[] =
		{
			{"diarrhea", 0.015} // diuretic, diarrhea
		};
	};
	...
	class Chemlight_red
	{
		...
		interactActions[] =
		{
			{"STR_vn_mf_attach", "call vn_mf_fnc_attach_chemlight;" }
		};
	};
	class Chemlight_yellow: Chemlight_red {};
	class Chemlight_green: Chemlight_red {};
	class Chemlight_blue: Chemlight_red {};
	
	class vn_prop_med_01  //  (Ration 0.75Kg) Etc
	{
		disallowRepack = 0;
		removeonempty = 1;
		consume = 25;
	...
	class vn_prop_med_antivenom : vn_prop_med_01
	{
		food = 0.15;
		cures[] =
		{
	...
	class vn_prop_med_antibiotics: vn_prop_med_01
	{
		cures[] =
		{
			{"salmonellosis",1},
	...
	class vn_prop_med_antimalaria : vn_prop_med_01
	{
		cures[] =
		{
			{"sick",0.2}
	...
	class vn_prop_med_dysentery : vn_prop_med_01
	{
		food = 0.15;
		cures[] =
		{
	...
	class vn_prop_med_painkillers : vn_prop_med_01
	{
		consume = 5;
		food = 0.15;
		cures[] =
	...
	class vn_prop_med_wormpowder : vn_prop_med_01
	{
		cures[] =
		{
			{"tapeworm",0.15}
	...
	class vn_fake_prop_energy_remover : vn_prop_med_01
	{
		cures[] =
		{
			{"energy",1}
