class CfgBuildingFeatures
{
	class example
	{
		...
		onSuppliesChanged = "";
		//Called when the building is connected to a FOB
		onBaseConnected = "";
		//Called when the building is disconnected from a FOB
		onBaseDisconnected = "";
		//Called when the building is connected to a COP
		onCopConnected = "";
		//Called when the building is disconnected from a COP
		onCopDisconnected = "";
		//onBuildingSave = "";
		//onBuildingLoad = "";
	};
