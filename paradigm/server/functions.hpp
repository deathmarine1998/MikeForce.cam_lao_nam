...
class para_s
{
	...
	class cleanup_arsenal
	{
		PARA_SERVER_PATH(\cleanup_arsenal);
		class cleanup_arsenal {};
		class cleanup_arsenal_init {};
	};
	...
	class play_rewards
	{
		PARA_SERVER_PATH(\play_rewards);
		class play_rewards {};
		class play_rewards_init {};
	};
	...
	{
		PARA_SERVER_PATH(\restart_messages);
		class restart_messages {};
		class restart_messages_init {};
		class restart_after_capture {};
		class restart_after_capture_init {};
		class restart_after_hold_init {};
		class restart_after_hold {};
	};
};
