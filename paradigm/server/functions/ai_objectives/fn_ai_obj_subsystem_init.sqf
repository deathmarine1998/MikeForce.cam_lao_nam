...
para_s_ai_obj_reinforce_block_direct_spawn_range = 400;
para_s_ai_obj_reinforce_reallocate_range = 600;

para_s_ai_obj_hard_ai_limit = 80;
para_s_ai_obj_bnmax_ai_limit = 130;

para_s_ai_obj_pursuitRadius = 300;
para_s_ai_obj_maxPursuitDistance = 800;
