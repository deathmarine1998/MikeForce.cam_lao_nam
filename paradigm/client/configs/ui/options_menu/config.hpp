...
class para_CfgOptions {
    ...
    class para_maxViewDist {
		...
		tooltip = "Max View Distance. Disabling Dynamic View Distance Above may decrease performance!"; // Tooltip
		type = "Slider";
		default = 750;
		range[] =  { 350, 5000 };
		step = 50;
    ...
    class para_maxObjectViewDist {
		...
		tooltip = "Max Object View Distance. Disabling Dynamic View Distance Above may decrease performancee!";
		type = "Slider";
		default = 600;
		range[] =  { 350, 5000 };
		step = 50;
    ...
    class para_minFpsViewDist {
		...
		tooltip = "Min FPS you must reach to keep your current View Distance value";
		type = "Slider";
		default = 10;
		range[] =  { 10, 240 };
		step = 1;
