/*
    File: fn_zone_marker_fob_info.sqf
    Author: Alablm
    Date: 2021-11-06
...
[_base] call para_c_fnc_buildable_resupply_info params [["_percentFull", "Initializing"], "_currentSupplies", "_suppliesUntilFull", "_lifetimeSecs"];
private _info = "";
